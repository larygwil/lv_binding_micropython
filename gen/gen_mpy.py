...
static const mp_obj_type_t *get_mp_{sanitized_struct_name}_type();
    ...
    if isinstance(type_ast, (c_ast.PtrDecl, c_ast.ArrayDecl)):
        ...
        if isinstance(type_ast.type, c_ast.FuncDecl):
            ...
            try:
                ...
                print(
                    "static mp_obj_t mp_lv_{f}(void *func){{ return mp_lv_funcptr(&mp_{f}_mpobj, func, NULL, MP_QSTR_, NULL); }}\n".format(
                        f=func_ptr_name
                    )
                )
